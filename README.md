...
___
## File Structure
> Note: `git clone` this repo in the same level directory as your [TensorFlow Models](https://github.com/tensorflow/models), illustrated below:
...
> Make sure you have completed step _5. Install Object Detection API for TensorFlow_, including running the `protoc` command.
___
# Workflow
...
> Note: The first `id` should start at 1.
...
2. Extract the `tar` file as a directory under `tf-object-detection-scripts/pretrained/`.
    * For example, it should look like `tf-object-detection-scripts/pretrained/ssd_mobilenet_v1_coco_checkpoint/`
