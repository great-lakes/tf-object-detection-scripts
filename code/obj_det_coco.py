"""Run object detection on video with sample pre-trained model
Use openCV to read video and apply coco object detection pre-trained model onto frames
...
# Define Arguments
parser = argparse.ArgumentParser(description='Run object detection on video with sample pre-trained model')
...
with detection_graph.as_default():
  with tf.Session(graph=detection_graph) as sess:
    while success:
      ...
      FRAME_PATH = f'../datasets/{DATASET_NAME}/frames/eval/frame_{VIDEO_FILE_ALTERED}_{frame_count}.jpg'
